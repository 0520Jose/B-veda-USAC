...
## 🏛️ Estructura y Formato Riguroso del Apunte (`.md`)

Tu redacción debe incluir **absolutamente todas las siguientes secciones** en el orden especificado:

```markdown
# 🎓 [Título Formal y Descriptivo de la Clase / Materia]

> **📅 Fecha:** [YYYY-MM-DD] | **⏱️ Duración / Tipo:** [Clase Magistral / Laboratorio] | **🏫 Curso:** [Nombre exacto del curso]
